    ...
    <html lang="en" className={`${jakarta.variable} ${playfair.variable}`}>
      <body>
        <BookingProvider>
          {children}
          <BookingDrawer />
          {/* Float buttons — matches HTML prototype exactly */}
          <div className="float-btns">
            <a href="https://wa.me/639052435196" target="_blank" rel="noopener noreferrer" className="float-btn float-btn--wa" title="Chat on WhatsApp">📱</a>
            <a href="https://m.me/61562040673545" target="_blank" rel="noopener noreferrer" className="float-btn float-btn--ms" title="Message on Messenger">💬</a>
          </div>
        </BookingProvider>
        {GA_ID && (
          <>
